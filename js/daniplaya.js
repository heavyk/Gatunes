		...
		DANIPLAYA.callback = function() {
			...
			PLAYER.current = {
				...
				getCurrentTime : function(callback) {
					callback(swf.getCurrentTime());
				},
				getDuration : function(callback) {
					callback(swf.getDuration() || song.time);
				},
				...
				seekTo : function(fraction) {
					PLAYER.current.getDuration(function(duration) {
						swf.seekTo(Math.round(duration * fraction));
					});
				},
				destruct : function() {
					$('#daniPlaya').remove();
			...
			delete DANIPLAYA.callback;
		};
	},
	onReady : function() {
		DANIPLAYA.callback && DANIPLAYA.callback();
	}
};
